...
You have to complete the file main.cpp.
The makefile will attempt also to build a main.
main.sol is an executable of my implementation that you could play with.
You have to download it and change it to an executable (chmod main.sol 755).
