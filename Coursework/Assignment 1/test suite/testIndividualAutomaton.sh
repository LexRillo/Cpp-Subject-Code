...
if [ ! -e "CopiedFilesAutomaton" ]
then
    for file in Automaton.cpp Automaton.h
    do
	cp ../${file} .
    done
    ...
    for file in makefile \
	        ...
	        Transition.h Transition.cpp \
                ModelState.h ModelState.o \
	        AutomatonTester.h AutomatonTester.cpp \
                AutomatonMain.cpp
    do
...
make AutomatonMain &> AutomatonCompilation.txt
...
runSimpleTest AutomatonMain a   # t.testAssOpMove()
runSimpleTest AutomatonMain b   # t.testStateChangeName()
runSimpleTest AutomatonMain c   # t.testMemory()
runSimpleTest AutomatonMain d   # t.testAssOpCopy()
runSimpleTest AutomatonMain e   # t.testMoveCtor()
runSimpleTest AutomatonMain f   # t.testIterateState()
runSimpleTest AutomatonMain g   # t.testCopyCtor()
runSimpleTest AutomatonMain h   # t.testBasic()
runSimpleTest AutomatonMain i   # t.testStability()
echo "Finished running all AutomatonMain tests"
